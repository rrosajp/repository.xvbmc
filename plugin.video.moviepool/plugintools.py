...
def add_item( itemcount=1,meta={} , action="" , title="" , plot="" , url="" ,thumbnail="" , extra="",mmsId="",page="",token="", isPlayable = False, folder=True ):
    try:
        meta['title'] = meta['title'].title()
    
        if action == 'Next':
            listitem = xbmcgui.ListItem( '[COLOR red]'+title+' [/COLOR]', iconImage="DefaultVideo.png", thumbnailImage=thumbnail )
        else:
