...
addon = xbmcaddon.Addon('script.upgrade.xvbmc')

def DownloaderClass(url,dest):
    dp = xbmcgui.DialogProgress()
    dp.create('XvBMC EPiC Upgrade','XvBMC Isengard upgrade downloaden','')
...
class MyClass(xbmcgui.Window):
  def __init__(self):
    ...
    if dialog.yesno('EPiC XvBMC Upgrade','Upgrade Helix-2-Isengard?'):
