...
OVERCLOCK_PRESETS = {'Disabled'       : (None, None, None,    2,  None, None, None),
                     'Modest'         : ( 950,  300,  450,    4,  None, None,    1),
                     'Turbo'          : (1000,  500,  450,    4,  None, None,    1),
                     'Super Turbo'    : (1064,  560,  450,    4,   350,  350,    1),
                     'Crazy'          : (1062,  590,  450,    4,   350,  350,    1)}
...
def restart_countdown(message, timeout=5):
