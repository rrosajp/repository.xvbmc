...
# ----------------------------------------------------------
    def add(self, rootFolder=None):
        menuItems = ["Add folder", "Add SportsDevilNL item", "Add xbmc favourite"]
        ...
        if select == 0:
            ...
            common.showInfo('Please browse through SportsDevilNL and use \ncontext menu entry "Add to SportsDevilNL favourites"')
        elif select == 2:
