...
movie_qua7 = settings.getSetting('movie_qua7')  # BluRay
movie_qua8 = settings.getSetting('movie_qua8')  # WEBRiP
movie_qua9 = settings.getSetting('movie_qua9')  # XviD
movie_qua10 = settings.getSetting('movie_qua10')  # TeleSync
movie_qua11 = settings.getSetting('movie_qua11')  # WEB-DL
movie_qua12 = settings.getSetting('movie_qua12')  # DTS
movie_qua13 = settings.getSetting('movie_qua13')  # SCREENER
movie_qua14 = settings.getSetting('movie_qua14')  # DVDRip
movie_qua15 = settings.getSetting('movie_qua15')  # AAC
movie_qua16 = settings.getSetting('movie_qua16')  # AC3
movie_qua17 = settings.getSetting('movie_qua17')  # BDRip
movie_qua18 = settings.getSetting('movie_qua18')  # HDRip
movie_qua19 = settings.getSetting('movie_qua19')  # BrRip
