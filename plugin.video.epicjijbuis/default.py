...
def randomizer(params):
 ...
 addDir(whoami,BASEURL,2,icondir,fanartdir,'')
 addDir('',BASEURL,2,icondir,fanartdir,'')
 plugintools.add_item(title="Miscellaneous \'[B]F[/B]ull [B]C[/B]oncerts\' [COLOR dimgray](Google\'s \'ik doe een gok\' [COLOR white];-p[/COLOR])[/COLOR]",url='plugin://plugin.video.youtube/search/?q=full+concert&sp=CAMSBhABGAIgAQ%253D%253D',thumbnail=icon,fanart=fanart,folder=True)
 plugintools.add_item(title="[COLOR white]NL[/COLOR][B] - [/B]Top [B]40[/B] [COLOR dimgray](\'playlist\\afspeellijst\' is het complete overzicht)[/COLOR]",url="plugin://plugin.video.youtube/user/"+YOUTUBE_CHANNEL_ID_6+"/",thumbnail=epicartwrk+'top40.png',fanart=epicartwrk+'LP40.jpg',folder=True)
