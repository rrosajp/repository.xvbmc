...
def main_list(params):
    ...
    plugintools.add_item( 
        title="[B][COLOR purple]EP[/B][COLOR dodgerblue]i[/COLOR][B]C[/B][/COLOR] [COLOR dimgray][B][COLOR darkmagenta]M[/COLOR][/B]usic [B][COLOR darkmagenta]V[/COLOR][/B]ideo [B][COLOR darkmagenta]C[/COLOR][/B]hannel[B] - [/B]it\'s like [COLOR mediumvioletred]MTV[/COLOR], [B]but[/B] bettâh[/COLOR][COLOR white]...[/COLOR]",
