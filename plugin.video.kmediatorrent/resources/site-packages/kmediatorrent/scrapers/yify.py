...
def yify_index():
    return [
        ...
        {"label": "Most Popular", "path": plugin.url_for("yify_movies", sort_by="download_count", order_by="desc", quality="all", page=1, limit=MOVIES_PER_PAGE)},
        {"label": "    in 720p", "path": plugin.url_for("yify_movies", sort_by="download_count", order_by="desc", quality="720p", page=1, limit=MOVIES_PER_PAGE)},
        {"label": "    in 1080p", "path": plugin.url_for("yify_movies", sort_by="download_count", order_by="desc", quality="1080p", page=1, limit=MOVIES_PER_PAGE)},
        {"label": "    in 3D", "path": plugin.url_for("yify_movies", sort_by="download_count", order_by="desc", quality="3D", page=1, limit=MOVIES_PER_PAGE)},
        ...
        {"label": "Most Recent", "path": plugin.url_for("yify_movies", sort_by="year", order_by="desc", quality="all", page=1, limit=MOVIES_PER_PAGE)},
        {"label": "    in 720p", "path": plugin.url_for("yify_movies", sort_by="year", order_by="desc", quality="720p", page=1, limit=MOVIES_PER_PAGE)},
        {"label": "    in 1080p", "path": plugin.url_for("yify_movies", sort_by="year", order_by="desc", quality="1080p", page=1, limit=MOVIES_PER_PAGE)},
        {"label": "    in 3D", "path": plugin.url_for("yify_movies", sort_by="year", order_by="desc", quality="3D", page=1, limit=MOVIES_PER_PAGE)},
    ]
...
def yify_genres():
    for genre in GENRES:
        yield {
            "label": genre,
            "path": plugin.url_for("yify_genre", genre=genre, sort_by="download_count", order_by="desc", quality="all", page=1, limit=MOVIES_PER_PAGE),
        }
