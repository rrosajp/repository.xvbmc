...
def perform_auto_conf(responses):
    ...
    if responses[0]: kodi.set_setting('WatchHD-auto_pick', 'true')
    if responses[1]: kodi.set_setting('auto-update_subs', 'true')
    if responses[2]: kodi.set_setting('show_pd', 'true')
    if responses[3]: kodi.set_setting('source_timeout', '20')
    if responses[4]: kodi.set_setting('library-update', 'true')
    if responses[5]: kodi.set_setting('filter_direct', 'false')
    if responses[6]: kodi.set_setting('filter_unusable', 'false')
    if responses[7]: kodi.set_setting('auto-disable', '0')
    if responses[8]: kodi.set_setting('source-win', 'Directory')
    if responses[9]:
        kodi.set_setting('enable_sort', 'true')
        kodi.set_setting('sort1_field', '2')
        kodi.set_setting('sort2_field', '4')
        kodi.set_setting('sort3_field', '3')
        kodi.set_setting('sort4_field', '0')
        kodi.set_setting('sort5_field', '0')
        kodi.set_setting('sort6_field', '0')
