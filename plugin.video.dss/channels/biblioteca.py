...
def mainlist(item):
    ...
    itemlist.append(Item(channel=item.channel, action="peliculas", title="Películas",
                         ...
                         thumbnail="https://raw.githubusercontent.com/dss-ce/media/master/dss/squares/thumb_biblioteca_peliculas.png"))
    itemlist.append(Item(channel=item.channel, action="series", title="Series",
                         category="Biblioteca de series",
                         thumbnail="https://raw.githubusercontent.com/dss-ce/media/master/dss/squares/thumb_biblioteca_series.png"))
    ...
    for nom_canal, json_path in list_canales.items():
        ...
        try:
            ...
            if "list_language" in item_json:
                # si se viene desde la biblioteca de dss
...
def update_serie(item):
    ...
    p_dialog = platformtools.dialog_progress_bg('dss', heading)
