    ...
    for index, channel in enumerate(channel_files):
        ...
        if channel.endswith(".xml"):
            try:
                ...
                # If he prefers the bannermenu and the channel has it, it changes now idea
                ...
                # The channel skips if it is not active
                ...
                # If it has come so far, he adds it
                ...
                logger.info("An error has taken place on having read the information of the channel " + channel)
                import traceback
