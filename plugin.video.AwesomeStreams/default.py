...
def ASIndex():
    ...
    addDir('[COLOR orange][B]************ (Sport)IPTV ************[/B][/COLOR]','',71,icon ,  fanart,'','','','')
...
#                print channel
                ...
                try:
                    if linkedUrl=='':
                        addDir(name.encode('utf-8', 'ignore'),url.encode('utf-8'),2,thumbnail,fanArt,desc,genre,date,strcredits,True)
                    else:
                        #print linkedUrl
