...
cp -rav /storage/.kodi/addons/script.xvbmc.update/resources/bin/SettingsSystemInfo-x265.xml /storage/.kodi/addons/skin.nox4beginners/1080i/SettingsSystemInfo.xml
