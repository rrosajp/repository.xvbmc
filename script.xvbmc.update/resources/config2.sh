...
cp -rav /storage/.kodi/addons/script.xvbmc.update/resources/bin/SettingsSystemInfo-turbo.xml /storage/.kodi/addons/skin.nox4beginners/1080i/SettingsSystemInfo.xml
