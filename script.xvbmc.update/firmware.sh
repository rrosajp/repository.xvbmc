...
# cp -rav /storage/.kodi/addons/sscript.xvbmc.update/Update.sh /storage/.kodi/userdata/scripts/firmware.sh       # duplicate script -2- /scripts/ #

kodi-send -a "Notification(XvBMC Firmware Update,FINISHED! PLEASE REBOOT...,4000,special://home/addons/script.xvbmc.update/icon.png)"
