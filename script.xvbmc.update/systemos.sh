...
kodi-send -a "Notification(XvBMC LibreELEC OS Update,preparing v6.90.004 and reboot when done...,5000,icon.png)"
...
curl http://releases.libreelec.tv/LibreELEC-RPi2.arm-6.90.004.tar -o /storage/.update/LibreELEC-RPi2.arm-6.90.003.tar

kodi-send -a "Notification(XvBMC SYSTEM Update Done,Reboot in 5 seconds...,5000,special://skin/icon.png)"
